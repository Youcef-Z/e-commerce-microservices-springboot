...
import com.youcef.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("y_zemirline@hotmail.com");
        ...
        try {
            ...
            log.info(String.format("INFO - Email sent to %s", destinationEmail));
